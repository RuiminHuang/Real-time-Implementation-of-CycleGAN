...
Status importSubgraph(
    IImporterContext* ctx, const ::onnx::GraphProto& subgraph, std::vector<nvinfer1::ILayer*>& newLayers)
{
...
Status addIfInputLayers(IImporterContext* ctx, nvinfer1::IIfConditional* conditional, InputsMap& inputsMap,
    const ::onnx::GraphProto& subgraph, const std::vector<nvinfer1::ILayer*>& newLayers)
{
...
Status addIfOutputLayers(IImporterContext* ctx, nvinfer1::IIfConditional* conditional,
    const ::onnx::GraphProto& thenGraph, const std::vector<nvinfer1::ILayer*>& thenLayers,
    const ::onnx::GraphProto& elseGraph, const std::vector<nvinfer1::ILayer*>& elseLayers,
    std::vector<TensorOrWeights>& graphOutputs)
{
    ...
    auto getReportedOutputs
        = [&ctx](const ::onnx::GraphProto& body, std::vector<std::string>& reportedOutputs) {
    ...
    auto getSubgraphOutputTensors
        = [](IImporterContext* ctx, std::vector<nvinfer1::ITensor*>& sgOutputs, SubgraphPortsMap& subgraphOutputs,
              const ::onnx::GraphProto& subgraph, std::vector<nvinfer1::ILayer*> subgraphLayers) {
...
Status getSubgraphTensors(const ::onnx::GraphProto& graph,
    ...
    const std::vector<std::string>* reportedOutputs = nullptr)
{
    ...
    using NodeProto = const ::onnx::NodeProto;
...
Status getSubgraphOutputs(const ::onnx::GraphProto& graph,
...
Status getSubgraphInputs(
    const ::onnx::GraphProto& graph, std::unordered_map<std::string, std::set<int32_t>>& externalInputs)
{
